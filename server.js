...
mongoose.connect('mongodb://localhost/foodCourt');//because we only want to use 1 database at a time,IF we want to use several databases at a time then mongoose.createconnection 
